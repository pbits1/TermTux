...
function renderSidebar() {
  ...
  let html = `
    <a href="index.html" class="nav-item ${window.location.pathname.endsWith('index.html') || window.location.pathname.endsWith('/') || !window.location.pathname.includes('.') ? 'active' : ''}">
    ...
    <a href="tools.html" class="nav-item ${window.location.pathname.endsWith('tools.html') ? 'active' : ''}">
